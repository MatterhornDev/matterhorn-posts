...
- [1 Set Up Guide](#1-set-up-guide)
  ...
  - [1.2 Adding ESLint](#1.2-adding-eslint)
    - [1.2.1 Initializing .eslintrc](#1.2.1-initializing-.eslintrc)
    - [1.2.2 Specifying environments](#1.2.2-specifying-environments)
    - [1.2.3 Specifying ecmaVersion](#1.2.3-specifying-ecmaVersion)
    - [1.2.4 Creating ESLint npm script](#1.2.4-Creating-ESLint-npm-script)
    - [1.2.5 Executing ESLint](#1.2.5-executing-eslint)
    - [1.2.6 Fixing an ESLint warning](#1.2.6-fixing-an-eslint-warning)
    - [1.2.7 Configuring ESLint](#1.2.7-configuring-eslint)
    - [1.2.8 Additional ESLint rule configuration](#1.2.8-additional-eslint-rule-configuration)
